package com.hasryApp.activities_fragments.driver.activity_home_driver.fragments;
...
import com.hasryApp.activities_fragments.driver.activity_order_details.OrderDetailsActivity;
import com.hasryApp.adapters.DriverOrderAdapter;
import com.hasryApp.databinding.FragmentOrderBinding;
...
public class Fragment_Previous_Order extends Fragment implements GoogleApiClient.OnConnectionFailedListener, GoogleApiClient.ConnectionCallbacks, LocationListener {
    ...
    private void getOrders()
    {
        try {
            ...
            Api.getService(Tags.base_url)
                    .getDriverOrders("Bearer "+userModel.getData().getToken(),"previous",userModel.getData().getId(),"driver",current_page,lat+"",lng+"")
